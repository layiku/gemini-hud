...
import { renderLayout, LAYOUT_HEIGHTS } from './layouts.js';
 ...
 */
export function render(metrics, { projectName = '', sessionFile = null, waiting = false, config = {}, historyStats = null } = {}) {
  ...
  const lines  = buildPanel(metrics, { projectName, sessionFile, waiting, cols, layout, theme, config, historyStats });
...
function buildPanel(metrics, { projectName, sessionFile, waiting, cols, layout, theme, config, historyStats }) {
